...
// make this inherit from a fixation class with a
// fixation method?
// need to think about how to make the trigger
namespace EnnsLab
{
    [RequireComponent(typeof(Canvas))]
    public class StreamFixation : AbstractPresenter
    {
        public event FixationEvent OnPresentation;
        public event FixationEvent AfterPresentation;

        #region private fields
        private string _possibleLetters;
        private string[] charStream;
        private string _targetLetter = "";
        public Text _charStreamText;
        ...
        #region Constructors
        StreamFixation(string possibleLetters, Vector3 fixation_position, float stimulus_duration, float display_duration)
        {
            CharStreamText = UnityEngine.Object.Instantiate(CharStreamText,
                new Vector3(0, 1), new Quaternion());
